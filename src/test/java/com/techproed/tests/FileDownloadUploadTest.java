...
// Kullanıcın ana klasörünün dosya yolunu veriyor. (String olarak)
       ...
       boolean varMi = Files.exists(Paths.get("C:\\Users\\Dell\\IdeaProjects\\SeleniumReviewTestNG\\pom.xml"));
...
// sendKeys ile upload etmek istediğimiz dosyanın adresini göndermemiz gerekiyor.
    chooseFile.sendKeys("C:\\Users\\Dell");
    ...
    public void dosyaIndirme(){
        ...
        boolean varMi = Files.exists(Paths.get("C:\\Users\\Dell\\Downloads\\Penguins.jpg"));
        Assert.assertTrue(varMi);
    }
